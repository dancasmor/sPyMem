...
if experiment == 1:
    ...
    # op -> t=0[0,2](5)=[7,8,9], t=7[2](4)=[6,7,8], t=14[0,1](3)=[5,6,7], t=21[0,2](5), t=26[2](4),
    #       t=31[2](4)=[0,1,5,6,7], t=38[0,1](3)=[0,1,8,9], t=45[2](4), t=50[0,1](3)
    inputSpikesCue = [[], [], [14, 15, 16, 38, 39, 40, 50], [7, 8, 9, 26, 31, 32, 33, 45], [0, 1, 2, 21]]
...
def test():
    ...
    # Plot results
    spikes_plot([inputSpikes, formatSpikesCue, formatSpikesCont, formatSpikesOut], ["IN", "Cue", "Cont", "OUT"],
                ["o", "o", "o", "o"], ["green", "darkviolet", "blue", "red"], ["IN", "CA3cue", "CA3cont", "OUT"],
                "Hipocampal (CA3 only) memory population spikes", "results/", experiment_name, False, True)
